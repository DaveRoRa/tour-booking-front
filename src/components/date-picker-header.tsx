...
} from "@mui/x-date-pickers/PickersCalendarHeader/PickersCalendarHeader.types"
import {
  getPickersCalendarHeaderUtilityClass,
  pickersCalendarHeaderClasses,
} from "@mui/x-date-pickers/PickersCalendarHeader/pickersCalendarHeaderClasses"
import type { PickerValidDate } from "@mui/x-date-pickers"
import { ArrowDropDownIcon, usePickersTranslations } from "@mui/x-date-pickers"
import {
...
const DatePickerHeader = React.forwardRef(function PickersCalendarHeader<
...
>(inProps: PickersCalendarHeaderProps<TDate>, ref: React.Ref<HTMLDivElement>) {
  ...
  const label = searchWithSameCase(utils.formatByString(month, format), dateTranslationsJsonMap)
